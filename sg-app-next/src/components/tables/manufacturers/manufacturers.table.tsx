...
const ManufacturersTable: React.FC = () => {
    const [manufacturers, setManufacturers] = useState<ManufacturerWithPermissions[]>([]);
    ...
    const refreshTable = async () => {
        try {
            ...
            if ("errors" in result) {
                ...
                const manufacturers = await getManufacturersPermissionStatus(result);
            ...
            <table className="min-w-full border-collapse border border-gray-200">
                <thead>
                    <tr className="bg-gray-100">
                        ...
                        <th className="border border-gray-200 p-2">Создатель</th>
