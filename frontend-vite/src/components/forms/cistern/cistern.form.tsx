    ...
    useEffect(() => {
        if (initialData) {
            reset({
                ...
                registrationDate: initialData.registrationDate ? initialData.registrationDate.split("T")[0] : new Date().toISOString().split("T")[0],
                    ...
                    <div className="relative mt-1 mb-8">
                        ...
                        {form.formState.errors.manufacturerId && (
                            <p className="mt-1 text-sm text-red-500">
                                {form.formState.errors.manufacturerId.message}
                            </p>
                        )}
                    </div>
                ...
                <div className="mt-8 border-t pt-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        <TextField
                            ...
                            label="Серийный номер сосуда"
                        />

                        <DatePicker
                            name="vesselBuildDate"
                            label="Дата изготовления сосуда"
                        />
                    </div>
